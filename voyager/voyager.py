...
class Voyager:
    def __init__(
            ...
            action_agent_model_name: str = "gpt-3.5-turbo-1106",
            action_agent_temperature: float = 0,
            action_agent_task_max_retries: int = 4,
            action_agent_show_chat_log: bool = True,
            action_agent_show_execution_error: bool = True,
            curriculum_agent_model_name: str = "gpt-3.5-turbo-1106",
            curriculum_agent_temperature: float = 0,
            curriculum_agent_qa_model_name: str = "gpt-3.5-turbo-1106",
            ...
            skill_manager_model_name: str = "gpt-3.5-turbo-1106",
